    ...
    <footer className="bg-dark text-white py-12">
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="hidden md:block">
          ...
          <div className="grid grid-cols-4 border border-gray-600 border-t-0">
            <div className="px-12 py-6">
              <h1 className="text-2xl md:text-3xl font-bold">Navigacija</h1>
            </div>
            <div className="px-12 py-6 border-l border-gray-600">
              <h1 className="text-2xl md:text-3xl font-bold">Kontakt</h1>
            </div>
            <div className="px-12 py-6 border-l border-gray-600">
              <h1 className="text-2xl md:text-3xl font-bold">Adresa</h1>
            </div>
            <div className="px-12 py-6 border-l border-gray-600">
          ...
          <div className="grid grid-cols-4 border border-gray-600 border-t-0">
            ...
            <div className="grid grid-rows-4 border-l border-gray-600">
              <a
                href="#"
                className="flex items-center gap-3 border-b border-gray-600 px-12 py-3 hover:bg-accent transition-colors"
              >
                <RiInstagramFill />
                <span>Instagram</span>
              </a>
          ...
          <div className="flex justify-between border border-gray-600 border-t-0">
